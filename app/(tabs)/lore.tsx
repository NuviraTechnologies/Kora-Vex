...
const styles = StyleSheet.create({
  ...
  headerSubtitle: { color: C.textDim, fontSize: 9, fontFamily: MONO, letterSpacing: 2, marginTop: 2 },
  ...
  headerBadgeLabel: { color: C.textDim, fontSize: 9, fontFamily: MONO, letterSpacing: 1 },
  ...
  filterPillText: { color: C.textDim, fontSize: 10, fontWeight: "800", fontFamily: MONO, letterSpacing: 1 },
  ...
  categoryPillText: { color: C.textDim, fontSize: 9, fontWeight: "800", fontFamily: MONO, letterSpacing: 1 },
  ...
  cardSummary: { color: C.textMid, fontSize: 13, lineHeight: 20, marginBottom: 12 },
  ...
  vexCommentPreviewText: { color: C.textDim, fontSize: 11, fontFamily: MONO, flex: 1, fontStyle: "italic" },
  ...
  modalDetail: { color: C.textMid, fontSize: 14, lineHeight: 24, marginBottom: 20 },
  ...
  vexCommentSubtitle: { color: C.textDim, fontSize: 10, fontFamily: MONO, marginTop: 2 },
  vexCommentText: { color: C.neon, fontSize: 14, lineHeight: 23, fontStyle: "italic" },
  ...
  closeBtnText: { color: C.textDim, fontSize: 12, fontWeight: "700", fontFamily: MONO, letterSpacing: 2 },
});
